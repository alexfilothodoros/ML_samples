...
def get_user_id(user_id:str):
    response = requests.get(f"http://localhost:8000/users/{str(id)}")
        ...
        {"type": "function",
            "function": {
                ...
                "parameters": {
                    "type": "object",
                    "properties": {
                    "user_id": {"type": "string", "default": "100", "description": "The id number of the user"}
                    }
                },
            },
...
user_id = 5
print(run_conversation(f"Get the user id of the user with id {user_id}"))
